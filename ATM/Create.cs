    ...
    public partial class Create : Form
    {
        ...
        private void Createbtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int confirm = int.Parse(ConfirmBox.Text);
                string em = Emailbox.Text;
                int bal = int.Parse(Balancebox.Text);

                if (PIN != confirm)
                {
                    MessageBox.Show("Those PINs didn’t match. Try again.");
                }
                else
                {
                    atmdataTableAdapter.InsertQuery(acc, f, l, phonenum, address, g, d, PIN, em, bal);
            ...
            {
                MessageBox.Show("Please enter the rest of information");
            }
           } 
